...
import { CheckCircle2, Lock, User, MapPin, Phone, Shirt } from "lucide-react";
...
const SimpleRegistration = () => {
  ...
  const handleSubmit = async (paymentStatus: "DONE" | "PENDING") => {
    ...
    try {
      ...
      const registrationData = {
        ...
        email: "simple@registration.com", // Default email
        mobile: form.mobile,
        gender: form.gender,
        ...
        emergency_contact_number: form.mobile, // Use same mobile as emergency
      ...
      if (paymentStatus === "DONE") {
        ...
        // Fetch the generated BIB number
        ...
        >
          ...
          <div className="pt-4 border-t border-purple-100">
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">
              &quot;Cash Received&quot; generates BIB immediately. &quot;Pay Later&quot; registers
              with pending status.
            </p>
          </div>
        </form>
