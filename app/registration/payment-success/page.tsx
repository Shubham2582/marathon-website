...
const SuccessContent = () => {
  ...
  const shareImage = async () => {
    ...
    try {
      ...
      const file = new File([blob], `RunWithMaad-${identificationNumber}.png`, {
        type: "image/png",
  ...
  const shareFallback = () => {
    const shareText = encodeURIComponent(
      `Check out my marathon certificate! 🏃‍♂️ #Runwithmaad #Marathon #Fitness`,
    );
    ...
    if (shareOption) {
      ...
      alert(
        "Link copied to clipboard! You can paste it in Instagram or other apps.",
      );
    }
  };
      ...
      setTimeout(() => {
        ...
        setTimeout(() => {
          ...
          const openStore = confirm(
            "Instagram app not found. Would you like to install it?",
          );
          if (openStore) {
