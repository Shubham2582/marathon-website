...
export async function POST(req: Request) {
  try {
    ...
    const paymentData = {
      ...
      email: params.email,
      phone: params.phone,
      surl: encodeURI(`${process.env.NEXT_PUBLIC_APP_URL}/api/payment-callback?identification_number=${params.identification_number}`),
      furl: encodeURI(`${process.env.NEXT_PUBLIC_APP_URL}/api/payment-callback?identification_number=${params.identification_number}`),
      hash,
    };
