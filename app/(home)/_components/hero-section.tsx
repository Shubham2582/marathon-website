  ...
  return (
    <section className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image src="/images/hero-section-bg.jpg" alt="Hero Section Background" fill className="object-cover brightness-90" priority />
      </div>

      <div className="w-full min-h-screen flex flex-col justify-center md:px-16 lg:px-24 relative z-10">
        {/* Hashtag */}
        <motion.p initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center md:text-xl lg:text-2xl text-[#FF4949] font-semibold">
          #RUNWITHMAAD
        </motion.p>
        ...
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
          ...
          <br />
          <span className="text-primary font-bold">Half Marathon 2026</span>
          <br />
          <motion.span
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ delay: 0.3, duration: 0.5 }}
            className="text-lg md:text-2xl lg:text-3xl text-[#FF4949] font-bold"
          >
            5th Edition
          </motion.span>
        </motion.h1>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-8 lg:gap-12 mt-8 md:mt-12 px-4">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-primary/30 to-[#FF4949]/30 backdrop-blur-md border-2 border-primary rounded-2xl px-6 md:px-8 py-4 shadow-lg shadow-primary/20"
          >
            <div className="text-center">
              <motion.div
                animate={{
                  textShadow: ["0 0 10px rgba(255, 73, 73, 0.5)", "0 0 20px rgba(255, 73, 73, 0.8)", "0 0 10px rgba(255, 73, 73, 0.5)"],
                }}
              ...
              <div className="text-xs md:text-sm text-white font-bold">Prize Pool 🏆</div>
            </div>
          </motion.div>
          ...
          <div className="flex items-center gap-6 md:gap-8">
            ...
            <div className="text-center">
              ...
              <div className="text-white text-xs md:text-sm font-semibold">Previous Edition</div>
            ...
            <div className="text-center">
              ...
              <div className="text-white text-xs md:text-sm font-semibold">Countries</div>
        ...
        {/* CTA Buttons */}
        <div className="flex justify-center items-center gap-8 mt-8 md:mt-10">
