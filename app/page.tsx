        ...
        {/* Mission Card */}
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                To create a transformative sporting event that brings together communities, 
                promotes peace, and showcases the natural beauty of Abujhmad. We aim to 
                build bridges between diverse groups while encouraging health, fitness, and 
                mutual understanding through the universal language of sports.
              </p>
            </div>
          ...
          >
            <div className="mb-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                To establish the Abujhmad Marathon as a symbol of peace and unity, 
                making it a premier international sporting event that contributes to 
                the region's development while inspiring future generations to embrace 
                physical fitness and community harmony.
              </p>
            </div>
            <ul className="space-y-3">
              {[
